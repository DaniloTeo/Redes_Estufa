'''
Codigo para simular o gerenciamento de um Irrigador baseado nas
...
while True:
	...
	# Recebe o corpo da mensagem baseado em seu tamanho
	...
	while True:
		...
		# Imprime o estado do atuador e o timestamp da mensagem que o ativou
